    ...
    public partial class FormConsultaComb : Form
    {
        ...
        private void btAtualizar_Click(object sender, EventArgs e)
        {
            ...
            if (linhaSelec > -1 && contExc > 0)
            {
                ...
                MessageBox.Show("ID:" + pessoaSelec.Id + "ATUALIZADO COM SUCESSO", "2°A informática", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void FormConsultaComb_Load(object sender, EventArgs e)
        {
        ...
        private void btDeletar_Click(object sender, EventArgs e)
        {
            ...
            if (linhaSelec > -1 && contExc > 0)
            {
                ...
                MessageBox.Show("ID:" + pessoaSelec.Id + "DELETADO COM SUCESSO", "2°A informática", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtNome.Clear(); txtCpf.Clear(); txtEmail.Clear(); txtRegistroGeral.Clear();
                contExc = 0;
                ListaPessoas = context.ListarPessoas();
                comboBox1.DataSource = ListaPessoas.ToList();
